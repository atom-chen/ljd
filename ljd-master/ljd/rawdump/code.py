...
_OPCODES = (
    ...
    (0x00, 	instructions.ISLT),
    (0x01, 	instructions.ISGE),
    (0x02, 	instructions.ISLE),
    (0x03, 	instructions.ISGT),

    (0x04, 	instructions.ISEQV),
    (0x05, 	instructions.ISNEV),
    (0x06, 	instructions.ISEQS),
    (0x07, 	instructions.ISNES),
    (0x08, 	instructions.ISEQN),
    (0x09, 	instructions.ISNEN),
    (0x0A, 	instructions.ISEQP),
    (0x0B, 	instructions.ISNEP),

    # Unary test and copy ops.
    (0x0C, 	instructions.ISTC),
    (0x0D, 	instructions.ISFC),
    (0x0E, 	instructions.IST),
    (0x0F, 	instructions.ISF),
